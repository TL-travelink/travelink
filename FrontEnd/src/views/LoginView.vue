      ...
      <div class="w-full px-8 md:px-32 lg:px-24">
        <form class="bg-white rounded-md shadow-2xl p-5" @submit.prevent="login">
          ...
          <button
            ...
            style="background: linear-gradient(90deg, #f6acb6 0%, #f8f4b6 100%)"
          >
            Login
          </button>
          ...
          <div class="flex justify-between mt-4">
            ...
            >
            <RouterLink class="text-sm ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all"
                        :to="{name:'sign-up'}">sign up</RouterLink>
          </div>
        </form>
      </div>
    </div>
...
<style scoped>
.login_img_section {
  background: linear-gradient(rgba(2, 2, 2, 0.5), rgba(0, 0, 0, 0.9)),
    url("@/assets/구한사진.jpeg") unset;
}
</style>
