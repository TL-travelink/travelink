          ...
          <div v-if="showModal3" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 max-w-md">
              <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-semibold">개인정보 수정</h2>
                <span class="text-4xl font-bold cursor-pointer" @click="closeModal3">&times;</span>
              </div>
              <form>
                <div class="mb-4">
                  <label for="height" class="block text-gray-700 font-bold mb-2">키:</label>
                  <input v-model="formData2.height" id="height" type="text" placeholder="키"
                ...
                <div class="mb-4">
                  ...
                  <input v-model="formData2.age" id="age" type="text" placeholder="나이"
                         class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-6">
